            ...
            <div class="row">
                ...
                <div class="col-md-10">
                    <a href="{{ route('users.edit') }}" class="d-flex justify-content-left">Account Setting</a>
                </div>
            </div>
            <div class="row">
                <div class="col-md-2">
                ...
                <div class="col-md-10">
                    <a href="" class="d-flex justify-content-left" onclick="document.getElementById('logout-form').submit()">Logout</a>
